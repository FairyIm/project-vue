  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(item,index) in userAddressList" :key="item.id">
        ...
        <p @click="attrSelect(item,userAddressList)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(item,index) in detailArrayList" :key="item.skuId">
          <li>
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea placeholder="建议留言前先与商家沟通确认" class="remarks-cont" v-model="buyMsg"></textarea>
      </div>
      <div class="line"></div>
      <div class="bill">
        <h5>发票信息：</h5>
    ...
    <div class="sub clearFix">
      ...
      <!-- <router-link class="subBtn" to="/pay" @click="submit">提交订单</router-link> -->
    </div>
  </div>
</template>
    ...
    methods:{
      ...
      async submit(){
        ...
        let params = {
          ...
          paymentWay:"ONLINE",
          orderComment:this.buyMsg,
          orderDetailList:this.detailArrayList
        }
        let res = await this.$API.reqsubmitOrders(tradeNo,params)
        console.log(res);
        if(res.code == '200'){
